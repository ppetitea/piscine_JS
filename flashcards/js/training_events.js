        ...
        import {get_training_cookie, initialize_view, show_flashcard_form_view, get_form_answer_result, update_flashcard_remaining_days, show_flashcard_valid_answer, update_step_view} from './../modules/training_view.mjs'
        ...
        $('.step').on('click', function() {
            training.current_id = $(this).attr('id').substr('step'.length);
        ...
        $('.check_button').on('click', function() {
            ...
            if (result)
            {
                ...
                show_flashcard_valid_answer(flashcards[training.current_id]);
        }) 
